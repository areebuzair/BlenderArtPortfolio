...
export default function Introduction() {
    return (<div className="Introduction">
        ...
        <Navlinks/>
        <p>I also have some experience in web development. This website was made using reactJS and vite. My skills include basic HTML, CSS and Javascript, and also HTML Canvas and ThreeJS. My webdev portfolio is currently under construction.</p>
    </div>)
}