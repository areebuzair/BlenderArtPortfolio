...
export default function StillImages() {
    ...
    return (<>
        <h1>My Artworks</h1>
        <p>I am <b>J. M Areeb Uzair</b>. I use Blender as a hobby, and also to create assets for various projects of mine. I have been using this software since 2022. Here are some of my still render (video section is under construction).</p>
